...
import { dbMongoInit, dbGetPatients, dbAddPatient } from './dbMongo';
...
function main() {
    ...
    app.post("/addPatient", (req, res, next) => {
        ...
        if (req.body && Object.keys(req.body).length != 6) {
            ...
            let myPatient = new Patient(req.body.idSSN, req.body.firstname, req.body.lastname,
